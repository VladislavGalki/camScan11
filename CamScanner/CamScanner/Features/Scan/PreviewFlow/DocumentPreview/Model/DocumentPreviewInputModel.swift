...
struct DocumentPreviewInputModel {
    ...
    static func scan(pages: [CapturedFrame], previewMode: PreviewMode, rememberedFilterKey: String? = nil) -> DocumentPreviewInputModel {
        .init(kind: .scan, pages: pages, previewMode: previewMode, rememberedFilterKey: rememberedFilterKey)
    }

    static func id(result: IdCaptureResult, previewMode: PreviewMode, rememberedFilterKey: String? = nil) -> DocumentPreviewInputModel {
